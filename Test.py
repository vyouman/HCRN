...
parser.add_argument('--checkpoint', type=str, default='best.pth', help="checkpoint for the main model")
...
logger.info('===> Loading the testing set')
if os.path.exists('/data/hyt_data'):
    load_path_prefix = '/data/hyt_data'
else:
    load_path_prefix = '/data1/hyt_data'

target_file = load_path_prefix + '/wsj/test.pkl'
interf_file = load_path_prefix + '/esc_audio/test.pkl'
